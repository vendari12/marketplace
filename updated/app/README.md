...
##NEW Updates
##errors
*if you get a configuration outside request error replace the original "__init__.py" file with the one from this Update
*if you get an unsupported pickle protocol:5 error replace the original "__init__.py" file with this update
* get errors due to importing "configure_uploads, FileStorage" from werkzueg, update the flask_uploads.py by importing them from werkzeug.utils and werkzeug.datastructures respectively...
